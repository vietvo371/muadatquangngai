...
const saleListings = [
  ...
  {
    id: 4,
    title: 'Đất hẻm ô tô 285 Phan Đình Phùng - trung tâm Quảng Ngãi',
    price: '1,39 tỷ',
    area: '72,6m²',
    address: '285 Phan Đình Phùng, Quảng Ngãi',
    postedAt: 'Đăng hôm nay',
...
const rentListings = [
  {
    id: 5,
    title: 'Cho thuê nhà nguyên căn 3 phòng ngủ khu trung tâm Quảng Ngãi',
    price: '8 triệu/tháng',
    area: '90m²',
    address: 'Nguyễn Du, Quảng Ngãi',
    postedAt: 'Đăng hôm nay',
  ...
  },
  {
    ...
    area: '60m²',
    address: 'Quang Trung, Quảng Ngãi',
    postedAt: 'Hôm qua',
