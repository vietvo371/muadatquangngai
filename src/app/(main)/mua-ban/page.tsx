...
const mockProperties: MockProperty[] = [
  {
    ...
    location: 'Quảng Ngãi, Quảng Ngãi',
    bedrooms: 2,
    bathrooms: 2,
    isVip: 'vip',
...
function PropertyListingContent() {
  ...
  // Bản đồ trên mobile mở dạng overlay (split-view chỉ hợp desktop).
  ...
  return (
    <div className="bg-gray-50 min-h-screen">
      ...
      {/* Mobile: nút mở bản đồ nổi + overlay toàn màn hình (split-view chỉ hợp desktop). */}
      <button
        type="button"
