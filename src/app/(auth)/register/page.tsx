...
export default function RegisterPage() {
  ...
  const handleOAuthRegister = (provider: 'google') => {
    window.location.href = `/api/v2/auth/oauth/${provider}/start`;
  };
    ...
    <div className="w-full">
      ...
      <div className="grid grid-cols-2 gap-3 mb-6">
        ...
        <Button
          ...
          disabled
          title="Sắp có"
          className="h-11 border-gray-200 font-medium text-[14px] text-gray-400 cursor-not-allowed"
        >
          <svg className="h-5 w-5 mr-2 text-gray-300" fill="currentColor" viewBox="0 0 24 24">
